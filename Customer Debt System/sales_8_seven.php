...
<div class = "include">
	...
	<div class = "table_info">
		...
		//	$start = $total - $perpage;
			...
			$sql = "select Shop_no, Date, Sales_amount, Costs_amount, Message from sales_shop where MONTH(Date)=7 and YEAR(Date)=2018 and Shop_no=8";
			...
			//	$total_debt+=$totaldebt_perpage;
				...
				echo "<div id='debt_form'>";
					echo "<p>7月当前总销售: ".$total_sales_amount."</p>";
					echo "<p>7月当前总费用: ".$total_costs_amount."</p>";
				echo "</div>";
