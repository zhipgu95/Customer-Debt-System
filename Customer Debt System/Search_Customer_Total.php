	...
	<div class = "table_info">
		...
		//	$start = $total - $perpage;
			$sql = "SELECT distinct concat(c.LastName, ' ', c.FirstName) AS name, c.Gender AS gender, c.City AS city, SUM(cr.Amount) AS amount
					FROM customer_record AS cr, customer AS c WHERE cr.LastName=c.LastName AND cr.FirstName=c.FirstName GROUP BY name ORDER BY amount DESC";
