...
<div class = "include">
	<div class = "info"><p>2号店调货系统</p></div>
	
	<div class = "table_info">
		<div id="menu">
		<div class="dropdown_new">
				<button class="dropbtn_new">2号店出货
					<i class="fa fa-caret-down"></i>
				</button>
				<div class="dropdown-content_new">
					<a href="items_out_2_one.php">1月份</a>
					<a href="items_out_2_two.php">2月份</a>
					<a href="items_out_2_three.php">3月份</a>
					<a href="items_out_2_four.php">4月份</a>
					<a href="items_out_2_five.php">5月份</a>
					<a href="items_out_2_six.php">6月份</a>
					<a href="items_out_2_seven.php">7月份</a>
					<a href="items_out_2_eight.php">8月份</a>
					<a href="items_out_2_nine.php">9月份</a>
					<a href="items_out_2_ten.php">10月份</a>
					<a href="items_out_2_eleven.php">11月份</a>
					<a href="items_out_2_twelve.php">12月份</a>
					<a href="items_out_2_2018.php">2018年</a>
					<a href="items_out_2_2019.php">2019年</a>
				</div>
		</div>
		<div class="dropdown_new">
				<button class="dropbtn_new">2号店入货
					<i class="fa fa-caret-down"></i>
				</button>
				<div class="dropdown-content_new">
					<a href="items_in_2_one.php">1月份</a>
					<a href="items_in_2_two.php">2月份</a>
					<a href="items_in_2_three.php">3月份</a>
					<a href="items_in_2_four.php">4月份</a>
					<a href="items_in_2_five.php">5月份</a>
					<a href="items_in_2_six.php">6月份</a>
					<a href="items_in_2_seven.php">7月份</a>
					<a href="items_in_2_eight.php">8月份</a>
					<a href="items_in_2_nine.php">9月份</a>
					<a href="items_in_2_ten.php">10月份</a>
					<a href="items_in_2_eleven.php">11月份</a>
					<a href="items_in_2_twelve.php">12月份</a>
					<a href="items_in_2_2018.php">2018年</a>
					<a href="items_in_2_2019.php">2019年</a>
				</div>
		</div>
    ...
    <div class = "provider">
    	<form method = "Post" action = "search_2.php"><br/>
