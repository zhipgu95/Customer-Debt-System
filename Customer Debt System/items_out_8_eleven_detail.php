		...
		//	$start = $total - $perpage;
			if(isset($_GET['search'])){
				...
				$sql = "select Demander, Provider, Date, Amount, Transfer_Detail 
						from items_transfer 
						where Provider=8 and MONTH(Date)=11 and YEAR(Date)=2018 and Demander='$demander'";
			...
			//	$total_debt+=$totaldebt_perpage;
				...
				echo "<div id='debt_form'>";
					echo "<p>8号店11月份出货金额数(到".$demander."号店): ".$total_amount_one."</p>";
				echo "</div>";
