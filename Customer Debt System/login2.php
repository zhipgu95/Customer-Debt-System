<?php
	...
	if(isset($_POST['submit'])){
		...
		if (username_exists($username, $password, $conn)){
			if ((($username=='admin') and ($password=='password')) or (($username=='jinpengtienda2') and ($password=='jinpeng2'))){
				header("location: sales_2.php");
			}
			else {
				$error = "当前账号没有权限查看!";
			}
...
<div class="table">
	...
	<div class = "table2">
    	<form method = "Post" action = "login2.php"><br/>
