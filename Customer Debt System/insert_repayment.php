...
<link href="css/insert_repayment.css" rel="stylesheet" />
</head>
<body>
...
<div class="table">
    ...
    <div class = "provider">
    	<form method = "Post" action = "insert_repayment.php" enctype="multipart/form-data"><br/>
        ...
        <input type = "submit" name = "submit" value = "添加该还款"/>
		</form>
    </div>
 </div>
