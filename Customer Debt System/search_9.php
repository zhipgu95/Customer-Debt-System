...
<div class = "include">
	<div class = "info"><p>9号店调货系统</p></div>
	
	<div class = "table_info">
		<div id="menu">
		<div class="dropdown_new">
				<button class="dropbtn_new">9号店出货
					<i class="fa fa-caret-down"></i>
				</button>
				<div class="dropdown-content_new">
					<a href="items_out_9_one.php">1月份</a>
					<a href="items_out_9_two.php">2月份</a>
					<a href="items_out_9_three.php">3月份</a>
					<a href="items_out_9_four.php">4月份</a>
					<a href="items_out_9_five.php">5月份</a>
					<a href="items_out_9_six.php">6月份</a>
					<a href="items_out_9_seven.php">7月份</a>
					<a href="items_out_9_eight.php">8月份</a>
					<a href="items_out_9_nine.php">9月份</a>
					<a href="items_out_9_ten.php">10月份</a>
					<a href="items_out_9_eleven.php">11月份</a>
					<a href="items_out_9_twelve.php">12月份</a>
					<a href="items_out_9_2018.php">2018年</a>
					<a href="items_out_9_2019.php">2019年</a>
				</div>
		</div>
		<div class="dropdown_new">
				<button class="dropbtn_new">9号店入货
					<i class="fa fa-caret-down"></i>
				</button>
				<div class="dropdown-content_new">
					<a href="items_in_9_one.php">1月份</a>
					<a href="items_in_9_two.php">2月份</a>
					<a href="items_in_9_three.php">3月份</a>
					<a href="items_in_9_four.php">4月份</a>
					<a href="items_in_9_five.php">5月份</a>
					<a href="items_in_9_six.php">6月份</a>
					<a href="items_in_9_seven.php">7月份</a>
					<a href="items_in_9_eight.php">8月份</a>
					<a href="items_in_9_nine.php">9月份</a>
					<a href="items_in_9_ten.php">10月份</a>
					<a href="items_in_9_eleven.php">11月份</a>
					<a href="items_in_9_twelve.php">12月份</a>
					<a href="items_in_9_2018.php">2018年</a>
					<a href="items_in_9_2019.php">2019年</a>
				</div>
		</div>
    ...
    <div class = "provider">
    	<form method = "Post" action = "search_9.php"><br/>
