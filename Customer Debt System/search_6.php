...
<div class = "include">
	<div class = "info"><p>6号店调货系统</p></div>
	
	<div class = "table_info">
		<div id="menu">
		<div class="dropdown_new">
				<button class="dropbtn_new">6号店出货
					<i class="fa fa-caret-down"></i>
				</button>
				<div class="dropdown-content_new">
					<a href="items_out_6_one.php">1月份</a>
					<a href="items_out_6_two.php">2月份</a>
					<a href="items_out_6_three.php">3月份</a>
					<a href="items_out_6_four.php">4月份</a>
					<a href="items_out_6_five.php">5月份</a>
					<a href="items_out_6_six.php">6月份</a>
					<a href="items_out_6_seven.php">7月份</a>
					<a href="items_out_6_eight.php">8月份</a>
					<a href="items_out_6_nine.php">9月份</a>
					<a href="items_out_6_ten.php">10月份</a>
					<a href="items_out_6_eleven.php">11月份</a>
					<a href="items_out_6_twelve.php">12月份</a>
					<a href="items_out_6_2018.php">2018年</a>
					<a href="items_out_6_2019.php">2019年</a>
				</div>
		</div>
		<div class="dropdown_new">
				<button class="dropbtn_new">6号店入货
					<i class="fa fa-caret-down"></i>
				</button>
				<div class="dropdown-content_new">
					<a href="items_in_6_one.php">1月份</a>
					<a href="items_in_6_two.php">2月份</a>
					<a href="items_in_6_three.php">3月份</a>
					<a href="items_in_6_four.php">4月份</a>
					<a href="items_in_6_five.php">5月份</a>
					<a href="items_in_6_six.php">6月份</a>
					<a href="items_in_6_seven.php">7月份</a>
					<a href="items_in_6_eight.php">8月份</a>
					<a href="items_in_6_nine.php">9月份</a>
					<a href="items_in_6_ten.php">10月份</a>
					<a href="items_in_6_eleven.php">11月份</a>
					<a href="items_in_6_twelve.php">12月份</a>
					<a href="items_in_6_2018.php">2018年</a>
					<a href="items_in_6_2019.php">2019年</a>
				</div>
		</div>
    ...
    <div class = "provider">
    	<form method = "Post" action = "search_6.php"><br/>
