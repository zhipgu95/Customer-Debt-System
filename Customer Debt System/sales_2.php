<?php
	...
	if(isset($_POST['submit']))
	{
		...
		else if(!(username_exists_2($conn))){
			$error = "您没有权限进行添加!";
		}
    ...
    <div id="menu">
		<div class="dropdown_new">
				...
				<div class="dropdown-content_new">
					<a href="sales_2_one.php">2018年1月</a>
					<a href="sales_2_two.php">2018年2月</a>
					<a href="sales_2_three.php">2018年3月</a>
					<a href="sales_2_four.php">2018年4月</a>
					<a href="sales_2_five.php">2018年5月</a>
					<a href="sales_2_six.php">2018年6月</a>
					<a href="sales_2_seven.php">2018年7月</a>
					<a href="sales_2_eight.php">2018年8月</a>
					<a href="sales_2_nine.php">2018年9月</a>
					<a href="sales_2_ten.php">2018年10月</a>
					<a href="sales_2_eleven.php">2018年11月</a>
					<a href="sales_2_twelve.php">2018年12月</a>
				</div>
		</div>
		<div class="dropdown_new">
				...
				<div class="dropdown-content_new">
					<a href="sales_2_2018.php">2018年</a>
					<a href="sales_2_2019.php">2019年</a>
				</div>
		</div>
		<a href="index.php">返回主页</a>
	</div>					
    <div class = "provider">
    	<form method = "Post" action = "sales_2.php"><br/>
