...
<div class = "include">
	...
	<div class = "table_info">
		...
		//	$start = $total - $perpage;
			...
			$sql = "select Shop_no, Date, Sales_amount, Costs_amount, Message from sales_shop where MONTH(Date)=3 and YEAR(Date)=2018 and Shop_no=9";
