...
<div class = "include">
	...
	<div class = "table_info">
		...
		//	$start = $total - $perpage;
			...
			$sql = "SELECT Shop_no, YEAR(Date) AS year, MONTH(Date) AS month, SUM(Sales_amount) AS monthly_sales_amount, SUM(Costs_amount) AS monthly_costs_amount FROM sales_shop WHERE YEAR(Date)=2019 AND Shop_no=5 GROUP BY month";
